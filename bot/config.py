...
ANSWER_TEXT = {
    ...
    "help": "Главная функция бота - ежедневная рассылка расписания, а также отслеживание изменений в нём в течение дня\n"
            "\n"
            "Вы можете подписаться на конкретные группы в меню /settings и настроить дня каждой их них параметр Рассылка 🌀\n"
            "\n"
...
ANSWER_CALLBACK = {"new_user": {
    ...
    "spam_or_subscribe_name_id": lambda action_type, result:
        f"{'Рассылка' if action_type == 'sp' else 'Подписка'} {'активирована' if result else 'удалена'}",
