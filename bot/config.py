...
ANSWER_TEXT = {"new_user": {
    ...
    "help": "В меню /settings вы сможете настроить работу бота под себя:\n"
            ...
            "\n"
            "Также, пары по числителю подчеркиваются, а по знаменателю вытянуты по ширине и находятся под парой-числителем\n"
            "",
...
ANSWER_CALLBACK = {"new_user": {
    ...
    "spam_or_subscribe_name_id": lambda action_type,
                                        result: f"{'Рассылка' if action_type == 'sp' else 'Подписка'} {'активирована' if result else 'удалена'}",
